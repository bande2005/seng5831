...
void init_timers() {
	...
	// Using CTC mode with OCR0 for TOP. This is mode 2, thus WGM0/1/0 = 1,0 (0x2).
	
	// Using pre-scaler 256. This is CS0/2/1/0 = 1,0,0 (0x4).
	TCCR0A = (1 << COM0A1) | (0 << COM0A0) | (0 << COM0B1) | (0 << COM0B0) | (0x0 << 3) | (0x0 << 2) | (1 << WGM01) | (0 << WGM00); //0x82;
	TCCR0B = (0 << FOC0A) | (0 << FOC0B) | (0x0 << 5) | (0x0 << 4) | (0 << WGM02) | (1 << CS02) | (0 << CS01) | (0 << CS00); //0x04;
	...
	TIMSK0 = (0x0 << 7) | (0x0 << 6) | (0x0 << 5) | (0x0 << 4) | (0x0 << 3) | (0 << OCIE0B) | (1 << OCIE0A) | (0 << TOIE0); //0x2;
	...
	// Using pre-scaler XX. This is CS1(3?)_210 = 0,1,1 = 0x3.
	...
	// Using PWM mode with OCR1A for TOP. This is mode XX, thus WGM3/3210 = .

	TCCR1A = (1 << COM1A1) | (0 << COM1A0) | (0 << COM1B1) | (0 << COM1B0) | (0x0 << 3) | (0x0 << 2) | (1 << WGM11) | (0 << WGM10);
	...
	// Using pre-scaler 1024. This is CS1/2/1/0 = 1,0,1.
	...
	TIMSK1 = (0x0 << 7) | (0x0 << 6) | (0 << ICIE1) | (0x0 << 4) | (0x0 << 3) | (0 << OCIE1B) | (1 << OCIE1A) | (0 << TOIE1); //0x2;
